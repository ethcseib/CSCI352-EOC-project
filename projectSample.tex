...
Some of the challenges we suspect to run into include programming the interaction between the player, character and game environment. This is drastically different from any programming projects we have attempted before. Creating in game objects like enemies and obstacles. This leads in to the environment interaction challenge. Challenge three is to create our different story lines and make sure they lead to an ending. Finally is the debugging. This is more of a patience challenge.
...
\section{Scope}
The project will be finished when we have multiple in game levels, a branching story, as bug free as possible and the world builds and functions properly. The minimum would be a game with a linear story opposed to the branching. THIS SECTION IS NOT FINISHED!!! needs stretch goals
