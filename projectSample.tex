...
\title{Burning Choices\\ for UTM CSCI 352 Spring 2017}
%
%
...
The project ,named "Burning Choices", is a 2D arcade game. It will be a 2D sidescroller action/ adventure game with platforming elements. The end goal of the project is to tell a story that branches depending on the actions of the player. The audience for this project would be those who enjoy retro style games. The audience will hopefully play the game and leave feeling satisfied/ entertained. The reason why we have chosen this project is thanks to different interests ranging from a love of video games to things we enjoy in our own lives and would like to create ourselves. The story will follow the story of the player as they find their way through our world overcoming any obstaclees in their way. in doing so they are given the ability to control their own story.
...
Throughout the paper these terms will be used in describing the game. 2D, sidescroller, platformer, branching storyline, linear storyline. 2D refers to the dimensions the game will be in i.e. 2D means 2 dimensions. Sidescroller refers to the gameplay to be expected. Sidescroller typically means the level is from left to right. you begin on the left and travel to the end (right). Platformer is another gameplay descriptor. This means the player will have to navigate at certain points by precisely jumping and landing on platforms to progress through the level. Branching storyline is a has existed in video games for a while and refers to how the story of the game progresses depending on the choice of the player. This means the player could end up with a different ending depending on what they do in the game. Linear storyline refers to the story within the game. It's a linear storyline when you are following a set in stone story meaning no matter your actions in game there is one story you follow with typically one ending. there is no branching. This is a team project so we all have our own motivations for choosing it. For me (Ethan Seiber) and Jamel Warren it's the video game aspect of it. I have personally played games for as  long as I could remember. Starting mainly with the ps2. Jamel and I plan to take our degrees here and going in to working in the game industry. For Hunter Haislip it's the the idea. Hunter received inspiration from the Black Mirror, a tv series, episode Bandersnatch to make the game have multiple endings based on player choice. Hence the title Burning Choices.

\subsection{Challenges}
\enumerate Programming the interaction between the player, character and game environment
\enumerate Creating in game objects like enemies and obstacles
\enumerate Learning how to run everything for testing
\enumerate Creating different storylines and endings (Creative Difficulty)
\enumerate Bug testing


\section{Scope}
The project will be finished when all desired goals are met. This means having multiple branching storylines and a finished game. The minimum would be a  game with a linear story. 
The goals we hope to accomplish thus far
\enumerate Multiple in game levels
\enumerate Branching story exists
\enumerate As bug free as possible
\enumerate The world is built
The stretch goals would be the branching storyline, save system and scoring system.
